...
class Writer(DataWriter):
    ...
    def _create_table_if_not_exists(self, table_name: str, table_data: pa.RecordBatch) -> None:
    ...
    async def push_data(self, data: Dict[str, pa.RecordBatch]) -> None:
        for table_name, table_data in data.items():
            ...
            self.client.insert_arrow(f"{table_name}", pa.Table.from_batches([table_data]))
